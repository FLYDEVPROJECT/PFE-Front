    ...
    return(
        <>
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				<Link className="btn btn-primary font-w600 mb-2 mr-auto" onClick={()=> setPostModal(true)}>+ nouvelle opération </Link>
				 {/* <!-- Modal --> */}
						...
						<div className="">
							<form >
								<div className="modal-header">
									<h4 className="modal-title fs-20">Ajouter une opération</h4>
								...
								<div className="modal-body">
									...
									<div className="add-contact-box">
										<div className="add-contact-content">
											...
											<div className="form-group mb-3">
												<label className="text-black font-w500">Hopital</label>
												<div className="contact-occupation">
													<input type="text"  autocomplete="off"
                ...
                <Modal className="modal fade"  show={editModal} onHide={setEditModal} >
					<div className="" role="document">
						<div className="">
							<form >
								<div className="modal-header">
									<h4 className="modal-title fs-20">Modifier Opération</h4>
								...
								<div className="modal-footer">
                                    <button type="submit" className="btn btn-primary" onClick={handleEditFormSubmit}>Enregistrer</button>  
                                    <button type="button" onClick={()=> setEditModal(false)} className="btn btn-danger"> <i className="flaticon-delete-1"></i> Annuler</button>      
								</div>
							</form>
                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <h6 className="fs-18 font-w500 mb-3"><Link to={"#"}className="text-black user-name"></Link></h6>
                                    <div className="text-dark fs-14 text-nowrap"><i className="fa fa-calendar-o mr-3" aria-hidden="true"></i></div>
                                </div>
                                <Dropdown className="">
                            ...
                            <div className="card-body p-0 pb-3">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">
                                        <span className="mb-0 title">Date de l'opération</span> :
                                        <span className="text-black ml-2">{contact.Date_Join}</span>
                                    </li>
                                    <li className="list-group-item">
                                        <span className="mb-0 title">Diagnostic</span> :
                                         <span className="text-black ml-2">{contact.Cust_Name}</span> 
                                    </li>
                                    <li className="list-group-item">
                                        <span className="mb-0 title">Hopital</span> :
