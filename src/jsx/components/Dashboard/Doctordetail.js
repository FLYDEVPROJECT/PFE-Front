   ...
   return (
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography><strong>Parcours universitaire</strong></Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
        Diplomé le 19/06/2013 de l'université Medicale de Iasi :
        <p>2012 : docteur en médecine.</p>
        <p>2013 : spécialiste en gynécologie obstétrique</p>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography><strong>Stages</strong></Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          stage interné qui a duré 1 ans . 
