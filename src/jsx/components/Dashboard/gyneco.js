...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La gynécologie, ou gynécologie-obstétrique, est une spécialité médicale qui vise l'étude, le diagnostic, le traitement ainsi que les actes relatifs à l'appareil génital des femmes. Le gynécologue obstétricien est un chirurgien spécialisé dans la chirurgie en relation avec l'appareil génital féminin et peut soit traiter soit intervenir à ce titre pour une infection au niveau d'un organe de cet appareil, pour des troubles hormonaux, pour une pathologie maline (cancer), pour une contraception, etc. Outre ces interventions, le gynécologue accompagne les femmes pendant la grossesse et lors de l'accouchement. Il traite aussi les problèmes d'infertilité féminine ainsi que troubles liés à la ménopause.</p>
         </div>
