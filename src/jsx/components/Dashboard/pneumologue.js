...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La pneumologie est la spécialité médicale qui concerne les soucis de santés relatifs aux organes suivants : les poumons, les bronches, la plèvre, et la trachée. Elle couvre de fait les infections de ces organes ainsi que les pathologies cancéreuses associés, les allergies. Les insuffisances respiratoires chroniques aussi bien que les apnées du sommeil font également partie du périmètre de la pneumologie.</p>
         </div>
