...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>L’urologie  est le domaine de la médecine qui s'applique aux reins, aux voies urinaires des femmes ou des hommes, au système reproducteur masculin (appareil urogénital masculin) et aux glandes surrénales.
Il s'agit d'une spécialité médicochirurgicale. Les praticiens qui s'en occupent sont appelés urologues.</p>
         </div>
