...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La pédiatrie est une spécialité médicale qui a pour vocation le suivi médical des enfants depuis leur naissance pour tous les aspects liés à leur santé. Le pédiatre prend en charge la vaccination, le contrôle du développement psycho-moteur et physiologique normal de l'enfant, traite maladies, etc. Il conseille également les parents pour la nutrition des enfants et surtout les bébés.</p>
         </div>
