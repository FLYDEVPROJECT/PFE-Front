...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La médecine interne est une spécialité médicale polyvalente qui s'intéresse au diagnostic des organes internes du corps humain avec un focus des situations complexes ou rares. Les principaux organes pris en charges par la médecine interne sont : le système digestif, le cœur, les poumons, etc. Certaines maladies rares ou systémiques chez l'adulte, tel que le lupus par exemple, sont parfois difficiles à détecter. La médecine interne a ainsi la particularité de couvrir plusieurs systèmes du corps humain ce qui aider à dépister notamment les maladies auto immunes.</p>
         </div>
