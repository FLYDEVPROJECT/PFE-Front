...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La gastro-entérologie est une spécialité médicale qui pour vocation de diagnostiquer et traiter les maladies relatives à l'appareil digestif. L'estomac est l'organe le plus connu par le grand public pour cette spécialité médicale. Cependant, le médecin gastro-entérologue traite les autres organes de l'appareil digestif, dont notamment le foie, le pancréas, la vésicule biliaire, l'œsophage, l'intestin grêle et le côlon.</p>
         </div>
