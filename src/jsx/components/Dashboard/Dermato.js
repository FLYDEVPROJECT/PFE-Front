...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>La dermatologie est une spécialité médicale qui vise à traiter et prévenir les maladies de la peau de manière générale et la maladies apparentées, telle que les maladies du tissu cellulaire sous-cutané, les maladies des muqueuses et des annexes de la peau de l'être humain. La dermatologie vise également le traitement des manifestations cutanées des maladies systémiques.</p>
         </div>
