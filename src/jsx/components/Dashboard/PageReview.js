...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p>L’ophtalmologie en médecine est la spécialité qui s'intéresse aux yeux, à leur structure et aux maladies associées. Le métier de l'ophtalmologue couvre les soucis de la vue, ainsi que les maladies de l’œil. L'ophtalmologue peut effectuer des interventions chirurgicales au niveau de yeux, ce qui lui accorde un statut de spécialiste et de chirurgien.</p>
         </div>
                        ...
                        <div className="card review-table">
                           <div className="media align-items-center">
                              ...
                              <div className="media-body d-lg-flex d-block row align-items-center">
                                 ...
                                 <div className="col-xl-7 col-xxl-7 col-lg-6 text-dark mb-lg-0 mb-2">
                                 Numéro de télephone :+21653741698
                                 </div>
