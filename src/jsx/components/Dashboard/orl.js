...
const PageReview = () => {
   return (
      <div className="h-70 ml-0">
         ...
         <p> L'ORL est l'abréviation de Oto-Rhino-Laryngologie. C'est une spécialité médicale et chirurgicale qui focalise sur le nez, la gorge, les oreilles et le larynx. L'ORL permet de traiter les soucis de l’odorat, de l'ouïe, des sinusites, de la voix, de la respiration, du goût, de l'équilibre, etc. Cette spécialité dont le nom est une composition de trois termes d’origine grecque, inclut également les actes de chirurgie cervico-faciale.</p>
         </div>
