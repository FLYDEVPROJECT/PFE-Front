...
const StepFourPro = ({ history }) => {
  ...
  const validate = Yup.object({
   ...
   confirmPassword: Yup.string()
     .oneOf([Yup.ref('password'), null], 'les 2 champs de mot de passe ne sont pas compatibles')
      ...
      {formik => (
        <div>
          <Form>
            ...
            <TextField label="Veuillez confirmer votre mot de passe" name="confirmPassword" type="password" />
          </Form>
        </div>
      )}
    </Formik>
